 ...
 */
// new Model Instance
$newModel = new \SmartemailingDeps\SmartEmailing\Api\Model\Email('Hello world, this is Subject!', 'Internal name of this e-mail, public will not see it', '&#x3C;span&#x3E;Hello!&#x3C;/span&#x3E;');
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))->emails()->create($newModel);
// Get Response
