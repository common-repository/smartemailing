 ...
 */
// new Model Instance
$contactList = new \SmartemailingDeps\SmartEmailing\Api\Model\ContactList('Changed name');
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))->contactLists()->update(769, $contactList);
// Get Response
