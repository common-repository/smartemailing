 ...
 */
// new Model Instance
$newCustomField = new \SmartemailingDeps\SmartEmailing\Api\Model\CustomFieldOption(119, 5, 'Tokyo');
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))->customFieldOptions()->create($newCustomField);
// Get Response
