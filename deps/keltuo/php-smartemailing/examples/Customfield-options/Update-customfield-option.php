 ...
 */
// new Model Instance
$customField = new \SmartemailingDeps\SmartEmailing\Api\Model\CustomFieldOption(119, 4, 'Change value 4');
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))->customFieldOptions()->update(20, $customField);
// Get Response
