 ...
 */
// Call Request
$list = (new SmartEmailing('usrname', 'apiKey'))->stats()->getNewsletterSummaries();
// Call Request with Search filter
$search = (new \SmartemailingDeps\SmartEmailing\Api\Model\Search\NewsletterStats())->setLimit(1);
$list = (new SmartEmailing('usrname', 'apiKey'))->stats()->getNewsletterSummaries($search);
