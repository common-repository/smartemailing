...
use SmartemailingDeps\Wpify\Model\Attributes\Column;
use SmartemailingDeps\Wpify\Model\Exceptions\KeyNotFoundException;
use SmartemailingDeps\Wpify\Model\Exceptions\PrimaryKeyException;
use SmartemailingDeps\Wpify\Model\Exceptions\RepositoryNotInitialized;
use SmartemailingDeps\Wpify\Model\Exceptions\SqlException;
...
abstract class CustomTableRepository extends Repository
{
    ...
    public function migrate() : void
    {
        ...
        if (!\function_exists('SmartemailingDeps\\dbDelta')) {
